...
(1..47).each do |q|
    begin
        if q < 10
            driver.get("https://www.jalan.net/a/minshuku/0#{q}0000/index.html")
            sleep(3)
            ...
            (3..32).each do |k|
                ...
                CSV.open('minshuku.csv','a',:encoding => "utf-8") do |csv|
                    csv << [cur_url, url, name]
                end
            end

        else 
            driver.get("https://www.jalan.net/a/minshuku/#{q}0000/index.html")
            sleep(3)
            cur_url = driver.current_url
            print(cur_url)
        ...
        p "xpathを取得中でエラーを吐きました。URL: https://www.jalan.net/a/minshuku/#{q}0000/index.html"
...
(1..47).each do |q|
    (2..15).each do |u|
        ...
        begin
            ...
            if q < 10
                driver.get("https://www.jalan.net/a/minshuku/0#{q}0000/index_#{u}.html")
                ...
                driver.get("https://www.jalan.net/a/minshuku/#{q}0000/index_#{u}.html")
            ...
            p "xpathを取得中でエラーを吐きました。URL: https://www.jalan.net/a/minshuku/0#{q}0000/index_#{u}.html"
